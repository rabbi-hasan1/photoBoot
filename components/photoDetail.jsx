import { getDictionaris } from "@/app/[lang]/dictonaris/dictionaris";
import Image from "next/image";
export default async function PostDetail({ id, lang }) {
  const dictionary = await getDictionaris(lang);
  const response = await fetch(`${process.env.REACT_BASE_URL}/photos/${id}`);
